...
public class Decompressor extends FileManager {
    ...
    public void prepareFile(){
        ...
        try {
            PrintWriter treeFileClear = new PrintWriter(new FileWriter("tree"));
            treeFileClear.close();
        } catch (IOException e) {
    ...
    public int decompress(File input, File output, Settings settings)  {
        ...
        allFlag.redundantZero = (c & 16) == 1; /* sprawdzenie, czy konieczne bedzie odlaczenie nadmiarowego koncowego znaku '\0' (16 == 0b00010000) */
